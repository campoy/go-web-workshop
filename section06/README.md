...
[this section](http://tour.golang.org/moretypes/5) of the Go tour.
...
[here](http://play.golang.org/p/rsO0Vk-9Xl).
...
Read more about pointers in the [Go tour](http://tour.golang.org/moretypes/1).
